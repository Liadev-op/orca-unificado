var LangText = {
  en: {
    t1: "Welcome to Snapmaker Orca",
    t2: "Snapmaker Orca will be setup in several steps. Let's start!",
    t3: "User Agreement",
    t4: "Disagree",
    t5: "Agree",
    ...
    t65: "Please be aware that these plugins are not developed or maintained by Snapmaker Orca. They should be used at your own discretion and risk.",
    ...
    t83: "2, Close all open Snapmaker Orca",
    t84: "3, Delete all files under the plug-in directory",
    t85: "4, Reopen Snapmaker Orca and install the plug-in again",
    t86: "Close",
    t87: "User Manual",
    t88: "Remove",
    ...
    orca6: "Account 1 of 2",
    orca6b: "Account 2 of 2",
    orca7: "Orca Cloud account",
    orca8: "Presets between PCs (cloud.orcaslicer.com). Not Snapmaker.",
    orca9: "Snapmaker account",
    orca10: "Bind U1 on Device. Does not sync Orca Cloud presets.",
    orca11: "Log in",
    orca12: "Log out",
    orca13: "Not signed in",
    orca14: "Signed in",
    orca15: "Stealth mode is on — Orca Cloud will not open. Disable it in Preferences.",
    orca16: "These are two different logins. Signing into Snapmaker will not fetch Orca Cloud presets.",
  },
    ca_ES: {
    t1: "Benvingut a Snapmaker Orca",
    t2: "Snapmaker Orca es configurarà en diversos passos. Comencem!",
    ...
    t52: "Saltar",
    t53: "Unir-se",
    t54: "A la comunitat d'Impressió 3D, aprenem dels èxits i fracassos dels altres per ajustar els nostres propis paràmetres i configuracions de laminació. Snapmaker Orca segueix el mateix principi i utilitza l'aprenentatge automàtic per millorar el seu rendiment a partir dels èxits i fracassos d'un gran nombre d'impressions dels nostres usuaris. Estem entrenant Snapmaker Orca per ser més intel·ligent alimentant-lo amb dades del món real. Si estàs disposat, aquest servei accedirà a informació dels teus registres d'errors i registres d'ús, que poden incloure informació descrita a la ",
    t55: "Política de Privacitat",
    t56: ". No recopilarem cap dada personal que pugui identificar directament o indirectament a un individu, incloent-hi noms, adreces, informació de pagament i números de telèfon. En habilitar aquest servei, acceptes aquests termes i la declaració sobre la Política de Privacitat.",
    t57: "",
    t58: "",
    t59: ".",
    t60: "Europa",
    ...
    t65: "Tingues en compte que aquests connectors no són desenvolupats ni mantinguts per Snapmaker Orca. S'han d'utilitzar a la teva discreció i risc.",
    ...
    t83: "2, Tanca totes les Snapmaker Orca obertes",
    t84: "3, Elimina tots els fitxers del directori de connectors",
    t85: "4, Reobre Snapmaker Orca i instal·la el connector de nou",
    t86: "Tancar",
  ...
  es_ES: {
    t1: "Bienvenido a Snapmaker Orca",
    t2: "Va a configurar Snapmaker Orca mediante varios pasos. ¡Vamos a comenzar!",
    ...
    t83: "2, Cerrar todos los Snapmaker Orca abiertos",
    t84: "3, Borrar todos los archivos en el directorio de complementos",
    t85: "4, Reabrir Snapmaker Orca e instalar el complemento de nuevo",
    t86: "Cerrar",
    ...
    orca6: "Cuenta 1 de 2",
    orca6b: "Cuenta 2 de 2",
    orca7: "Cuenta Orca Cloud",
    orca8: "Presets entre PCs (cloud.orcaslicer.com). No es Snapmaker.",
    orca9: "Cuenta Snapmaker",
    orca10: "Bind de la U1 en Device. No sincroniza presets de Orca Cloud.",
    orca11: "Entrar",
    orca12: "Salir",
    orca13: "Sin sesión",
    orca14: "Con sesión",
    orca15: "Stealth está activo — Orca Cloud no abre. Desactívalo en Preferencias.",
    orca16: "Son dos inicios de sesión distintos. Entrar en Snapmaker no trae los presets de Orca Cloud.",
  },
  de_DE: {
    t1: "Willkommen im Snapmaker Orca",
    t2: "Das Snapmaker Orca wird in mehreren Schritten eingerichtet. Lass uns anfangen!",
    ...
    t83: "2, Schließen Sie alle geöffneten Snapmaker Orca",
    t84: "3, Löschen Sie alle Dateien im Plug-in-Verzeichnis",
    t85: "4, Öffnen Sie Snapmaker Orca erneut und installieren Sie das Plug-in erneut",
    t86: "Schließen",
  ...
  cs_CZ: {
    t1: "Vítejte v Snapmaker Orca",
    t2: "Snapmaker Orca bude nastaven v několika krocích. Začněme!",
    ...
    t83: "2, Zavřete všechny otevřené Snapmaker Orca",
    t84: "3, Smažte všechny soubory v adresáři plug-in",
    t85: "4, znovu otevřete Snapmaker Orca a znovu nainstalujte zásuvný modul",
    t86: "Zavřít",
  ...
  fr_FR: {
    t1: "Bienvenue sur Snapmaker Orca",
    t2: "Snapmaker Orca sera configuré en plusieurs étapes. Commençons !",
    ...
    t65: "Veuillez noter que ces plugins ne sont pas développés ou maintenus par Snapmaker Orca. Ils doivent être utilisés à votre propre discrétion et à vos propres risques.",
    ...
    t83: "2, Fermez toutes les fenêtres de Snapmaker Orca",
    t84: "3, Supprimez tous les fichiers dans le répertoire du plug-in",
    t85: "4, Relancez Snapmaker Orca et réinstallez le plug-in.",
    t86: "Fermer",
    ...
    wk2: "Cet article présente l'utilisation la plus basique de Snapmaker Orca. Il guide les utilisateurs pour configurer le logiciel, créer des projets et effectuer la première tâche d'impression étape par étape.",
    wk3: "Workflow basé sur des projets",
    wk4: "Snapmaker Orca met en avant un workflow de pointe pour véritablement réaliser un projet « tout en un ». Basé sur le format de projet 3MF grand public, il fournit une série de nouvelles fonctionnalités révolutionnaires, telles que la prise en charge de plusieurs plaques, un gestionnaire de ressources de projet et une vue d'assemblage/de pièce. Cela améliore considérablement l'efficacité des créateurs et des utilisateurs réguliers",
    ...
    wk15: "Texte 3D",
    wk16: "Avec l'outil Texte 3D, les utilisateurs peuvent facilement créer diverses formes de texte 3D dans le projet, ce qui rend le modèle plus personnalisé. Snapmaker Orca fournit des dizaines de polices et prend en charge les styles gras et italique pour donner au texte une plus grande flexibilité.",
  },
  zh_CN: {
    t1: "欢迎使用Snapmaker Orca",
    t2: "Snapmaker Orca需要几步安装步骤，让我们开始吧！",
    t3: "用户使用协议",
    t4: "拒绝",
    t5: "同意",
    ...
    t64: "Bambu网络插件",
    t65: "注意：这些插件不是由Snapmaker Orca开发或维护的。使用它们需自担风险",
    t66: "强大的远程控制功能",
    t67: "实时视频流",
    t68: "用户数据同步",
    t69: "安装Bambu网络插件",
    ...
    t81: "1, 点击",
    t82: "打开插件所在目录",
    t83: "2, 关闭所有Snapmaker Orca",
    t84: "3, 删除插件所在目录下的所有文件",
    t85: "4, 重新启动Snapmaker Orca并尝试安装插件",
    t86: "关闭",
    t87: "使用引导",
    t88: "移除",
    t89: "打开所在的文件夹",
    ...
    wk3: "基于项目的工作流",
    wk4: "Snapmaker Orca提出了领先的工作流程，真正实现了“一体化”项目。基于主流的3MF项目格式，它提供了一系列革命性的新功能，如支持多盘、项目资源管理器和装配/零件视图。它可以大幅提高模型创作者及普通用户的使用效率。",
    wk5: "质量卓越的高速打印",
    wk6: "在保持高质量的前提下进行高速打印是非常具有挑战性的。Snapmaker Orca让这一切发生。支持“圆弧移动”特性使工具头移动更加顺滑，有效减少机器振动。基于不同材料类型的精细标定过的冷却控制参数，使得冷却过程可以自动开展。在悬垂区域进行“自动减速”，可防止高速打印时在此区域的外观瑕疵。",
    wk7: "多色打印",
    wk8: "Snapmaker Orca提供了多种着色工具来制作彩色模型。您可以在项目中自由添加/移除打印材料，并使用不同的笔刷为模型着色。开始打印时，打印任务中的各个材料将自动映射到匹配的AMS槽位，无需手动调整AMS中的料卷位置。",
    wk9: "切片参数设置指南",
    wk10: "Snapmaker Orca中的参数管理功能为切片过程提供了非常灵活和强大的控制。本文介绍了切片参数的组织分类和设置方法，并提供了一些使用技巧。",
    wk11: "远程控制和监控",
    wk12: "Snapmaker Orca支持通过WAN/LAN网络向打印机发送打印任务，控制和查看3D打印机和打印任务的各个方面。如果您有多台打印机，还可以在设备列表中轻松切换。",
    wk13: "STEP格式",
    wk14: "与STL相比，STEP带来了更多有效的信息。由于STEP的高精度，切片时可以生成更多的圆弧路径。STEP还包括模型每个零件的装配关系，可分割模型后恢复装配视图。",
    wk15: "3D文本",
    wk16: "使用3D文本工具，用户可以轻松地在项目中创建各种3D文本形状，使模型更加个性化。Snapmaker Orca提供了数十种字体，并支持粗体和斜体样式，使文本具有更大的灵活性。",
    orca1: "编辑项目信息",
    orca2: "该模型没有相关信息",
  },
  zh_TW: {
    t1: "歡迎使用 Snapmaker Orca",
    t2: "Snapmaker Orca 需要幾步安裝步驟，讓我們開始吧！",
    t3: "使用者協議",
    t4: "拒絕",
    t5: "同意",
    t6: "幫助提升 Snapmaker Orca 性能",
    t7: "允許傳送匿名數據",
    t8: "上一步",
    t9: "下一步",
    t10: "選擇３Ｄ列印機",
    ...
    t52: "忽略",
    t53: "同意",
    t54: "在3D列印社區，我們從彼此的成功和失敗中學習調整自己的切片參數和設置。Snapmaker Orca 遵循同樣的原則，透過機器學習的方式從大量用戶列印的成功和失敗中獲取經驗，從而改善列印性能。我們正在通過向 Snapmaker Orca 提供真實世界的數據來訓練他們變得更聰明。如果您願意，此服務將訪問您的錯誤日誌和使用日誌中的資訊，其中可能包括",
    t55: "隱私政策",
    ...
    t81: "1, 點擊",
    t82: "打開插件所在目錄",
    t83: "2, 關閉所有 Snapmaker Orca",
    t84: "3, 刪除插件所在目錄下的所有文件",
    t85: "4, 重新啟動 Snapmaker Orca 並嘗試安裝插件",
    t86: "關閉",
    t87: "使用引導",
    t88: "移除",
    t89: "打開所在的文件夾",
    ...
    orca2: "no model information",
    wk1: "快速入門指南",
    wk2: "本文介紹了 Snapmaker Orca 的最基本用法。它指導用戶配置軟體，創建項目，並逐步完成第一個列印任務。",
    wk3: "基於項目的工作流",
    wk4: "Snapmaker Orca 提出了領先的工作流程，真正實現了“一體化”項目。基於主流的3MF項目格式，它提供了一系列革命性的新功能，如支持多盤、項目資源管理器和裝配/零件視圖。它可以大幅提高模型創作者及普通用戶的使用效率。",
    wk5: "質量卓越的高速列印",
    wk6: "在保持高品質的前提下進行高速列印是非常具有挑戰性的。Snapmaker Orca 讓這一切發生。支持“圓弧移動”特性使工具頭移動更加順滑，有效減少機器振動。基於不同線材類型的精細標定過的冷卻控制參數，使得冷卻過程可以自動開展。在懸垂區域進行“自動減速”，可防止高速列印時在此區域的外觀瑕疵。",
    wk7: "多色列印",
    wk8: "Snapmaker Orca 提供了多種著色工具來製作彩色模型。您可以在項目中自由添加/移除列印材料，並使用不同的筆刷為模型著色。開始列印時，列印任務中的各個線材將自動映射對應到 AMS 槽位，無需手動調整 AMS 中的線材位置。",
    wk9: "切片參數設置指南",
    wk10: "Snapmaker Orca 中的參數管理功能為切片過程提供了非常靈活和強大的控制。本文介紹了切片參數的組織分類和設置方法，並提供了一些使用技巧。",
    wk11: "遠端控制和監控",
    wk12: "Snapmaker Orca 支持透過無線網路/區域網路向３Ｄ列印機發送列印任務，控制和查看３Ｄ列印機和列印任務的各個方面。如果您有多台３Ｄ列印機，還可以在設備清單中輕鬆切換。",
    wk13: "STEP格式",
    wk14: "與 STL 相比，STEP 帶來了更多有效的資訊。由於 STEP 的高精度，切片時可以生成更多的圓弧路徑。STEP 還包括模型每個零件的組裝關係，可分割模型後恢復裝配視圖。",
    wk15: "３Ｄ文本",
    wk16: "使用３Ｄ文字工具，使用者可以輕鬆地在項目中建立各種３Ｄ文字形狀，使模型更加個性化。Snapmaker Orca 提供了數十種字體，並支援粗體和斜體樣式，使文字具有更大的靈活性。",
  },
  ru_RU: {
    t1: "Приветствуем в Snapmaker Orca!",
    t2: "Для настройка Snapmaker Orca необходимо пройти несколько этапов. Давайте начнём!",
    ...
    t52: "Пропустить",
    t53: "Войти",
    t54: "В сообществе 3D-печатников для выявления наилучших параметров нарезки и улучшения печати мы учимся на успехах и неудачах друг друга. Snapmaker Orca следует тому же принципу и использует машинное обучение для улучшения своей работы на основе успешных и неудачных печатей наших пользователей. Мы обучаем Snapmaker Orca быть умнее на основе реальных данных. По вашему согласию эта служба получит доступ к вашим журналам ошибок и журналам использования, в которых содержатся сведения, описанные в ",
    ...
    t83: "2, Закрыть все открытые Snapmaker Orca",
    t84: "3, Удалить все файлы в папке плагина",
    t85: "4, Откройте Snapmaker Orca и снова установите подключаемый модуль.",
    t86: "Закрыть",
    t87: "Инструкции",
    t88: "Удалить",
  ...
  ko_KR: {
    t1: "Snapmaker Orca에 오신 것을 환영합니다",
    t2: "Snapmaker Orca는 여러 단계로 설정됩니다. 시작!",
    t3: "사용자 약관",
    t4: "거부",
    t5: "동의",
    ...
    t52: "건너뛰기",
    t53: "가입",
    t54: "3D 프린팅 커뮤니티에서 우리는 각자의 슬라이싱 매개변수와 설정을 조정하는 과정에서 서로의 성공과 실패를 통해 배웁니다. Snapmaker Orca는 동일한 원칙을 따르며 기계 학습을 사용하여 사용자의 방대한 출력물의 성공과 실패를 통해 성능을 향상시킵니다. 우리는 실제 데이터를 제공하여 Snapmaker Orca가 더욱 똑똑해지도록 교육하고 있습니다. 귀하가 원할 경우 이 서비스는 오류 로그 및 사용 로그의 정보에 액세스합니다. 여기에는 다음에 설명된 정보가 포함될 수 있습니다.",
    t55: "개인 정보 정책",
    ...
    t83: "2, 열려 있는 모든 Snapmaker Orca를 닫습니다.",
    t84: "3, 플러그인 디렉터리 아래의 모든 파일 삭제합니다",
    t85: "4, Snapmaker Orca를 다시 열고 플러그인을 다시 설치하세요.",
    t86: "닫기",
    t87: "사용자 메뉴얼",
    t88: "제거",
    t89: "포함된 폴더 열기",
  ...
  tr_TR: {
    t1: "Snapmaker Orca'a hoş geldiniz",
    ...
    t65: "Lütfen bu eklentilerin Snapmaker Orca tarafından geliştirilmediğini veya bakımının yapılmadığını unutmayın. Kendi takdirinize ve riskinize göre kullanılmalıdırlar.",
    ...
    t83: "2, Tüm açık Snapmaker Orcaı kapatın",
    t84: "3, Eklenti dizini altındaki tüm dosyaları silin",
    t85: "4, Snapmaker Orca'ı yeniden açın ve eklentiyi tekrar yükleyin",
    t86: "Kapat",
  ...
  pl_PL: {
    t1: "Witamy w Snapmaker Orca",
    t2: "Snapmaker Orca zostanie skonfigurowany w kilku krokach. Zacznijmy!",
    ...
    t52: "Pomiń",
    t53: "Dołącz",
    t54: "W społeczności druku 3D uczymy się od sukcesów i porażek innych, aby dostosować nasze własne parametry i ustawienia krojenia. Snapmaker Orca podąża tą samą zasadą i wykorzystuje uczenie maszynowe do poprawy swojej wydajności na podstawie sukcesów i porażek dużej liczby wydruków naszych użytkowników. Szkolimy Snapmaker Orca, aby był mądrzejszy, dostarczając mu danych z rzeczywistego świata. Jeśli chcesz, ta usługa uzyska dostęp do informacji z Twoich logów błędów i logów użytkowania, które mogą zawierać informacje opisane w ",
    ...
    t65: "Proszę mieć świadomość, że te wtyczki nie są rozwijane ani utrzymywane przez Snapmaker Orca. Powinny być używane na własne ryzyko i z rozwagą.",
    ...
    t83: "2, Zamknij wszystkie otwarte Snapmaker Orca",
    t84: "3, Usuń wszystkie pliki z katalogu wtyczek",
    t85: "4, Ponownie otwórz Snapmaker Orca i zainstaluj wtyczkę ponownie",
    t86: "Zamknij",
  ...
  pt_BR: {
    t1: "Bem-vindo ao Snapmaker Orca",
    t2: "Snapmaker Orca será configurado em algumas etapas. Vamos começar!",
    t3: "Termos de Uso",
    t4: "Discordo",
    t5: "Concordo",
    ...
    t65: "Por favor seja cuidadoso estes plugins não são desenvolvidos ou mantidos por Snapmaker Orca. Eles devem ser usados por sua conta e risco.",
    ...
    t83: "2, Feche totalmente o Snapmaker Orca",
    t84: "3, Delete todos os arquivos na pasta do plug-in",
    t85: "4, Reabra o Snapmaker Orca e instale o plug-in novamente",
    t86: "Fechar",
